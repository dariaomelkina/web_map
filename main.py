...
def map(year, lat, long):
    map = folium.Map(location=[48.314775, 25.082925], zoom_start=5, tiles='Stamen Terrain')
    map.save('Map_2.html')
...
#     lat, long = map((lambda x: int(x)), input("Please enter your location (format: lat, long): ").split(", "))
